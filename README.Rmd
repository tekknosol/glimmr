...
obtained by chamber measurements into gasfluxes. Data recorded with different devices can be processed automatically.
The model fitting itself is done with the `gasfluxes` package.
