...
test_that("Flux calculation stops", {
  expect_error(
    preprocess_gasmet(gasmet, meta_gasmet),
    "missing temperature values in meta file. Flux calculation stoped."
  )
})
...
test_that("Window & Offset", {
  expect_warning(
    process_gasmet(gasmet, meta_gasmet1, pre = T),
    "No window provided in meta file. Set to 10."
  )
  expect_warning(
    process_gasmet(gasmet, meta_gasmet, pre = T),
    "No offset provided in meta file. Set to 0."
  )
})
