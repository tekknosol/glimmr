...
## Meta data
  ...
  * **offset** (Default = 0). Column containing the number of datapoints skipped at the beginning of the  data chunk (e.g. `offset`). 
  
    Alternatively a single number applied as offset to all measurements (e.g. `2`).
